...
import com.anupawar.appupdate.Net.DownLoadService;
import com.anupawar.appupdate.Net.DownLoadTask;
import com.anupawar.appupdate.R;
import com.anupawar.appupdate.Utils.FileUtils;
...
public class DownLoadDialog extends DialogFragment implements View.OnClickListener {
    ...
    private void doCancel() {
        ...
        getActivity().finish();
        TastyToast.makeText(getActivity(),getActivity().getResources().getString(R.string.update_lib_download_cancel),TastyToast.LENGTH_SHORT,TastyToast.WARNING);
    ...
    private void doBackground() {
        ...
        if (getActivity() != null) {
            TastyToast.makeText(getActivity(),getActivity().getResources().getString(R.string.update_lib_download_in_background),TastyToast.LENGTH_SHORT,TastyToast.INFO);
            ...
            switch (msg.what) {
                ...
                case DONE:
                    if (getActivity() != null) {
                        ...
                        getActivity().finish();
                        TastyToast.makeText(getActivity(),getActivity().getResources().getString(R.string.update_lib_download_finish),TastyToast.LENGTH_SHORT,TastyToast.SUCCESS);

                    }
                    break;
                case ERROR:
                    if (getActivity() != null)
                        TastyToast.makeText(getActivity(),getActivity().getResources().getString(R.string.update_lib_download_failed),TastyToast.LENGTH_SHORT,TastyToast.ERROR);
                    if (!mMustUpdate) {
                        dismiss();
                        if (getActivity() != null)
                            getActivity().finish();
